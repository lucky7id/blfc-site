...
In case you were not redirected, you can finish your reservation <a href="${checkoutUrl}" style="color: #3498db; text-decoration: underline;">here</a>
<br />
<br />
...
class Mailer {
  ...
  sendWelcome(to, checkoutUrl, name, id) {
